...
##design matrices
##load meta data
load(paste0("scData/Nathan_NatImm_coldata.RData"))
...
for (i in 1:50){
  ...
  print(Sys.time())
  save(felme, tvlme, plme, slme, gnm, rtlme, 
       convlme, singlme, file = paste0(dirOut, "/TB_lmer_default.RData"))
}##i
...
##################################################
##comparison of results for FALSH-MM (lmmfit) and LME4-LMER
#####
##lmmfit
